...
var _arrowDropUp = require('material-ui/lib/svg-icons/navigation/arrow-drop-up');

var _arrowDropUp2 = _interopRequireDefault(_arrowDropUp);

var _arrowDropDown = require('material-ui/lib/svg-icons/navigation/arrow-drop-down');

var _arrowDropDown2 = _interopRequireDefault(_arrowDropDown);

var _nestedList = require('material-ui/lib/lists/nested-list');
...
var ListItem = _react2.default.createClass({
  ...
  //  textHoverColor={'#000'}
    ...
    var textColor = _props3.textColor ? _props3.textColor : this.state.muiTheme.rawTheme.palette.textColor;
    var textHoverColor = _props3.textHoverColor ? _props3.textHoverColor : null;
    ...
    var styles = {
      ...
      //  color: (this.state.isKeyboardFocused || this.state.hovered) ? '#333' : '#EEE',
        color: (this.state.isKeyboardFocused || this.state.hovered) ? textHoverColor : textColor,
        display: 'block',
        fontSize: 16,
        lineHeight: '16px',
        position: 'relative',
